...
A continuación se listan las actividades con las fechas de inicio y fin establecidas para el proyecto. Se tienen en cuenta las siguientes consideraciones:
...
En la figura \ref{fig:diagGantt}, se muestra el de diagrama de gantt realizado para el proyecto.
...
\begin{figure}[htpb]
\centering 
\includegraphics[height=.85\textheight]{./Figuras/TF-gantt.png}
...
\begin{consigna}{black}
Se presenta el presupuesto del proyecto. Está expresado en dólares americanos (USD).
